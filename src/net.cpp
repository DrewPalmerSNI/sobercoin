...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sobercoin " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x9845d912, 0xd90b6017, 0x5664419f
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sobercoin is probably already running."), addrBind.ToString().c_str());
        else
